...
There are several bash functions sourced that you can run,
  ...
  2. run_tests: This will run several unit tests to confirm the validity of the above
  ...
  4. run_lr_example: This will run a "Logistic Regression" (LR) example allowing users
  ...
  5. run_psi_example: this will execute an example that uses the HElib library and the
