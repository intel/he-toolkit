...
def test_copyfiles_execution(mocker):
    ...
    mock_copyfile = mocker.patch("command_docker_build.copyfile")
...
def test_create_buildargs_other(mocker):
    ...
    mock_getuid = mocker.patch("command_docker_build.getuid")
    mock_getuid.return_value = exp_uid
    mock_getgid = mocker.patch("command_docker_build.getgid")
...
def test_create_tar_gz_file_execution(mocker):
    ...
    mock_print = mocker.patch("command_docker_build.print")
    mock_open = mocker.patch("command_docker_build.open")
    mock_filter = mocker.patch("command_docker_build.filter_file_list")
    mock_filter.return_value = exp_files
    mock_compress = mocker.patch("command_docker_build.archive_and_compress")
...
def test_setup_docker_clean(mocker):
    ...
    mock_rmtree = mocker.patch("command_docker_build.rmtree")
    mock_print = mocker.patch("command_docker_build.print")
    mock_print_preamble = mocker.patch("command_docker_build.print_preamble")
    mock_DockerTools = mocker.patch("command_docker_build.DockerTools")
...
def test_setup_docker_vscode(mocker):
    ...
    mock_create_tar_gz = mocker.patch("command_docker_build.create_tar_gz_file")
    mock_copyfiles = mocker.patch("command_docker_build.copyfiles")
    mock_change_dir = mocker.patch("command_docker_build.change_directory_to")
